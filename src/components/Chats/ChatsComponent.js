  ...
  return (
    <>
      <Grid container spacing={2}>
          ...
          <div className="whatsapp_main_sidemenu">
            <div className="whatapp_main_sidemenu_top">
              <Grid container spacing={2} className="profile-icon">
                ...
                <Grid item xs={6}>
                  <Grid container spacing={2} className="row text-center chat-icon my-3">
                    <Grid item xs={4}>
              ...
              <div className="whatapp_main_sidemenu_bottom_chat">
                <ul className="list-group chat-card">
                  <li className="list-group-item">
                    <Grid container spacing={2} className="personal-message">
                      <Grid item xs={3} className="col-3">
                        <img src="/images/profile.png" className="Avatar" alt="" />
                      </Grid>
                      <Grid item xs={9} className="col-9">
                        <h6 style={{ fontSize: '14px' }} className="font-weight-bold">
                          User Name
                        </h6>
        ...
        <Grid item xs={8}>
          <div className="whatsapp_main_body">
            <div className="whatapp_main_sidemenu_top">
              <div className="row">
                <div className="Avatar  col-lg-5 col-md-5 col-sm-2">
            ...
            <div>
              <ul className="personal-chat">
                <div className="row chat1">
                  <li className="personal-edit">kjbo;abc onaos cljalwboae knaeowfulekwjfniuewoinsncjklcjq cj l j ol</li>
                </div>
            ...
            <div className="whatsapp_main_sidemenu_middle">
              ...
              <textarea className="w-100 message" type="text" name="text" placeholder="Message" rows="2" />
